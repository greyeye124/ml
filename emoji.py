...
emoji_dist={0:cur_path+'/test/angry.png',1:cur_path+"/test/disgusted.png",2:cur_path+"/test/fearful.png",3:cur_path+"/test/happy.png",4:cur_path+"/test/neutral.png",5:cur_path+"/test/sad/png"}

global last_frame1
last_frame1=np.zeros((480,640,3),dtype=np.int8)
global cap1
show_text={0}
global frame_number
